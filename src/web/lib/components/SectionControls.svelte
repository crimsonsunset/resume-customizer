...
>
    ...
    <div class="space-y-2">
        ...
        <div class="collapse collapse-arrow bg-base-200 transition-all hover:bg-base-300"
             class:collapse-open={accordionState.primary}>
            ...
            <div class="collapse-content space-y-2">
                ...
                {#each availableSectionsByCategory.primary as section}
                    <label class="flex items-center space-x-2 cursor-pointer transition-all hover:bg-base-100 p-1 rounded">
                        <input type="checkbox" class="checkbox checkbox-sm transition-transform hover:scale-110"
        ...
        <div class="collapse collapse-arrow bg-base-200 transition-all hover:bg-base-300"
             class:collapse-open={accordionState.credentials}>
        ...
        <!-- Social Proof -->
        <div class="collapse collapse-arrow bg-base-200 transition-all hover:bg-base-300"
             class:collapse-open={accordionState.socialProof}>
        ...
        <!-- Personality -->
        <div class="collapse collapse-arrow bg-base-200 transition-all hover:bg-base-300"
             class:collapse-open={accordionState.personality}>
